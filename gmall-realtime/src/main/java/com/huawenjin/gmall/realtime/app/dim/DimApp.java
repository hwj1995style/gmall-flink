package com.huawenjin.gmall.realtime.app.dim;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.huawenjin.gmall.realtime.app.func.DimSinkFunction;
import com.huawenjin.gmall.realtime.app.func.TableProcessFunction;
...
//程序：  Mock -> Mysql(binlog)  -> Maxwell -> Kafka(ZK) -> DimApp(FlinkCDC/Mysql binlog)  -> Phoenix(Hbase/ZK/HDFS)
...
public class DimApp {
    public static void main(String[] args){
        ...
        //2.读取Kafka totic_db 主题数据创建主流
        String topic = "topic_db";
        String groupId = "dim_app_230219";
        DataStreamSource<String> kafkaDS = env.addSource(MyKafkaUtil.getFlinkKafkaConsumer(topic,groupId));

        //3.过滤掉非Json数据&保留新增、变化以及初始化数据以及初始化数据并将数据转换为JSON格式
