...
public class PhoenixUtil {
    /**
     *
     * @param druidPooledConnection     Pheonix连接
     * @param sinkTable                 表名   tn
     * @param data                      数据   {“id”：“1001”， “name”：“zhangsan”， “sex”：“male”}
     */
    public static void upsertValues(DruidPooledConnection druidPooledConnection, String sinkTable, JSONObject data) throws SQLException {
