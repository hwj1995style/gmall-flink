...
//        System.setProperty("HADOOP_USER_NAME","huawenjin");
        ...
        //1.3 设置状态的 TTL， 生产环境设置为最大乱序程度
        tableEnv.getConfig().setIdleStateRetention(Duration.ofSeconds(10));

        //TODO 2.使用DDL 方式读取 topic_db 主题的数据创建表
        tableEnv.executeSql(MyKafkaUtil.getTopicDb("order_pre_process_2023"));


        //TODO 3.过滤出订单明细数据 作为主表
...
//        //转换为流并测试
//        tableEnv.toAppendStream(orderDetailTable, Row.class)
//                .print(">>>>>>>>>>>>");
        ...
        //转换为流并测试
//        tableEnv.toAppendStream(orderInfoTable, Row.class)
//                .print(">>>>>>>>>>>>");
        ...
        //转换为流并测试
//        tableEnv.toAppendStream(orderActivityTable, Row.class)
//                .print(">>>>>>>>>>>>");


        //TODO 6.过滤出订单明细购物券关联表
        ...
        //转换为流并测试
//        tableEnv.toAppendStream(orderCouponTable, Row.class)
//                .print(">>>>>>>>>>>>");
        ...
        Table resultTable = tableEnv.sqlQuery("select " +
                ...
                "inner join base_dic FOR SYSTEM_TIME AS OF od.pt AS dic  " +
